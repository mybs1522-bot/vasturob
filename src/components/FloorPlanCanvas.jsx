...
export default function FloorPlanCanvas({
  ...
  return (
    <div className="clean-card p-3 sm:p-4 space-y-3 bg-white">
      ...
      {/* Black Pills for White Slate Mode */}
      {!imageUrl && !svgContent && isCustomGridMode && (
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {blackPillsList.map((pill) => (
              <button
                ...
                className="bg-slate-900 hover:bg-slate-800 text-white px-2 py-1 rounded-full text-[8.5px] sm:text-[9px] font-normal tracking-wide flex items-center justify-center shadow-2xs transition-all hover:scale-102 active:scale-95 text-center whitespace-nowrap"
              >
